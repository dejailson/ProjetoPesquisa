...
class cadastrarProjeto:
    def __init__(self, lista):
        ...
        self.Nome = t.Label(self.root, text=self.lista.nome, width=98,  bg='white', relief="groove")
        ...
        self.Data = t.Label(self.root, text=lista.data, width=45, bg='white', relief="groove")
        ...
        self.Descricao = t.Label(self.root, text=self.lista.descricao, width=83, height = 5, bg='white', relief="groove")
    ...
    def visu(self):
        for c in self.lista.pesquisadores:
            self.tree.insert("", 'end',values=[c.matricula, c.nome, c.tipoMembro, c.coordenador], tag='1')
